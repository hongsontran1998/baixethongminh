...
<div class="row">
    ...
    <div class="col-lg-6">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <a href="${pageContext.request.contextPath}/adminUrl/#myModal" data-toggle="modal" class="btn btn-xs btn-success">
                    Form in Modal
                </a>
                <a href="${pageContext.request.contextPath}/adminUrl/#myModal-1" data-toggle="modal" class="btn btn-xs btn-warning">
                    Form in Modal 2
                </a>
                <a href="${pageContext.request.contextPath}/adminUrl/#myModal-2" data-toggle="modal" class="btn btn-xs btn-danger">
                    Form in Modal 3
                </a>
                            ...
                            <div class="modal-body">
                                <form class="form-inline" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control sm-input" id="exampleInputPassword5"
                                            placeholder="Password">
                                    </div>
                                    <div class="checkbox">
                                        <label>
                            ...
                            <div class="input-group m-b-10">
                                <div class="input-group-btn">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="${pageContext.request.contextPath}/adminUrl/#">Action</a></li>
                                        <li><a href="${pageContext.request.contextPath}/adminUrl/#">Another action</a></li>
                                        <li><a href="${pageContext.request.contextPath}/adminUrl/#">Something else here</a></li>
                                        <li class="divider"></li>
                                        <li><a href="${pageContext.request.contextPath}/adminUrl/#">Separated link</a></li>
                                    </ul>
                                </div>
                                <input type="text" class="form-control">
                            </div>
